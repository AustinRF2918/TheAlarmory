...
describe('Application Controller (Integration)', function() {
	...
	it ('Correctly messages to selected time component.', function() {
	    ...
	    expect( timeDisplay.__generateTemplate() ).to.equal('<div id="#test"><h3 class="text-body text-extra"><strong>At <span id="hour-alarm">2</span><span id="exxtra">:</span><span id="minute-alarm">20</span><span id="when-alarm"> PM</span></strong></h3></div>' );
	} );
    });
});
